      ...
      {loading ? (
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* LEFT COLLUMN: SYSTEM CALENDAR WRAPPER */}
                ...
                {calendarDays.map((day, idx) => {
                  ...
                  return (
                    <div
                      ...
                      className={`min-h-[64px] border p-1 rounded-lg flex flex-col justify-between cursor-pointer transition text-left group ${
                        isSelected 
